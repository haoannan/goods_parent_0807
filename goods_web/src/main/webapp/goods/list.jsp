...
<head>
	...
	<script>
        $(function () {
            $.ajax({
                method:"get",
                url:"${pageContext.request.contextPath}/goods/findAllGoods",
                dataType:"json",
                success:function (data) {
                    $(data).each(function () {
                        $("#ta").append("<tr><td>"+this.goods_name+"</td><td>"+this.category.cname+"</td><td>"+this.goods_number+"</td><td>"+this.goods_price+"</td><td>"+this.guarantee_period+"</td><td> <a href='#'>修改</a> <a href='#'>删除</a> </td><tr>")
                    })
                }
            })
        })
...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table id="ta" class="table table-hover">
                <thead>
					<tr>
						<th>商品名称</th>
						<th>所属分类</th>
